...
latas = ['boston', 'chicago bullslosanges lakers',
         'new york nicks', 'golde state warriors']
for lata in latas:
    print(lata+'\n')
...
for livro in livros:
    print(livro.title()+',',
          'foi um livro muito marcante para mim, me encinou varias lições.')
...
print(animais[2]+" " +
      'não preciso nem comentar sobre esse animal , é o felino mais rapido mundo.')
...
jogos = ['fifa 2020', 'clash of clans', 'the sims',
         'star wars', 'xadrez', 'bem10', 'dragon boll']
print(jogos[0:2])
